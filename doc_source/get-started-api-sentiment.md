...
+ [BatchDetectSentiment](API_BatchDetectSentiment.md) – Determine the overall sentiment in up to 25 documents in a batch\. For more information, see [Using the Batch APIs](get-started-batch.md)\.
