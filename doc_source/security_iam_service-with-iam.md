# How Amazon Comprehend works with IAM<a name="security_iam_service-with-iam"></a>
...
## Identity\-based policies for Amazon Comprehend<a name="security_iam_service-with-iam-id-based-policies"></a>
...
### Identity\-based policy examples for Amazon Comprehend<a name="security_iam_service-with-iam-id-based-policies-examples"></a>
...
## Resource\-based policies within Amazon Comprehend<a name="security_iam_service-with-iam-resource-based-policies"></a>
...
## Policy actions for Amazon Comprehend<a name="security_iam_service-with-iam-id-based-policies-actions"></a>
...
## Policy resources for Amazon Comprehend<a name="security_iam_service-with-iam-id-based-policies-resources"></a>
...
## Policy condition keys for Amazon Comprehend<a name="security_iam_service-with-iam-id-based-policies-conditionkeys"></a>
...
## ACLs in Amazon Comprehend<a name="security_iam_service-with-iam-acls"></a>
...
## ABAC with Amazon Comprehend<a name="security_iam_service-with-iam-tags"></a>
...
## Using temporary credentials with Amazon Comprehend<a name="security_iam_service-with-iam-roles-tempcreds"></a>
...
## Cross\-service principal permissions for Amazon Comprehend<a name="security_iam_service-with-iam-principal-permissions"></a>
...
## Service roles for Amazon Comprehend<a name="security_iam_service-with-iam-roles-service"></a>
...
## Service\-linked roles for Amazon Comprehend<a name="security_iam_service-with-iam-roles-service-linked"></a>
